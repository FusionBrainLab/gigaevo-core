r"""Trivial lattice seed: the aligned honeycomb tiling, no optimization.
...
class Solver:
    ...
    def solve(self, hex_num: int, seed=None) -> tuple[np.ndarray, np.ndarray]:
        return _lattice_config(hex_num)
