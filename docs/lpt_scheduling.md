...
~/envs/evo_fast/bin/python -m pytest tests/evolution/test_scheduling*.py -v

# Just integration tests
~/envs/evo_fast/bin/python -m pytest tests/evolution/test_scheduling_integration.py -v
```
