...
def setup_logger(
    ...
    logger.info(f"🎨 Enhanced colored logger initialized. Logging to console and {log_file}")
    logger.debug(f"📊 Log level: {level}, Colors: {enable_colors and sys.stdout.isatty()}")
    return log_file 